...
/**
The function below computes the normal vector in each cell. Applying *boundary*
to the normal vector field allows to get consistent values in the ghost cells. */
...
void face_fraction (scalar f, face vector s)
{
  ...
  compute_normal (f, normal_vector);
  foreach_face() {
